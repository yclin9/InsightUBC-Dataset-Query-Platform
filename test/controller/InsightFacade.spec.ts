...
describe("InsightFacade", function () {
	...
	describe("AddDataset", function () {
		...
		it("should reject with an id with an underscore", async function () {
			try {
				await facade.addDataset("my_dataset", sections, InsightDatasetKind.Sections);
				expect.fail("Should have thrown!");
			} catch (err) {
				expect(err).to.be.an.instanceOf(InsightError);
			}
		...
		it("should reject duplicate id", async function () {
			await facade.addDataset("my-dataset", sections, InsightDatasetKind.Sections);
			try {
				await facade.addDataset("my-dataset", sections, InsightDatasetKind.Sections);
				expect.fail("Should have thrown!");
			} catch (err) {
		...
		it("should accept this valid id", async function () {
			const result = await facade.addDataset("my-dataset", sections, InsightDatasetKind.Sections);
		...
		it("should reject invalid zip file", async function () {
			try {
				await facade.addDataset("my-dataset", "not-a-zip", InsightDatasetKind.Sections);
				expect.fail("Should have thrown!");
			} catch (err) {
				expect(err).to.be.an.instanceOf(InsightError);
			}
		...
		it("should reject with no courses/ folder", async function () {
			try {
				await facade.addDataset("my-dataset", noCoursesFolder, InsightDatasetKind.Sections);
				expect.fail("Should have thrown!");
			} catch (err) {
				expect(err).to.be.an.instanceOf(InsightError);
			}
		...
		it("should reject with invalid section", async function () {
			try {
				await facade.addDataset("my-dataset", invalidSection, InsightDatasetKind.Sections);
				expect.fail("Should have thrown!");
			} catch (err) {
				expect(err).to.be.an.instanceOf(InsightError);
			}
		...
		it("should accept with valid section", async function () {
			await facade.addDataset("my-dataset1", validSection, InsightDatasetKind.Sections);
			const result = await facade.addDataset("my-dataset2", validSection, InsightDatasetKind.Sections);
		...
		it("should persist dataset across new InsightFacade instances", async function () {
			await facade.addDataset("my-dataset", validSection, InsightDatasetKind.Sections);
	...
	describe("ListDataset", function () {
		...
		it("should return an array with length of two when adding two dataset", async function () {
			try {
				// SETUP
				await facade.addDataset("my-dataset1", validSection, InsightDatasetKind.Sections);
				await facade.addDataset("my-dataset2", validSection, InsightDatasetKind.Sections);
	...
	describe("PerformQuery", function () {
		...
		beforeEach(async function () {
			await facade.addDataset("small", smallDataset, InsightDatasetKind.Sections);
		});
